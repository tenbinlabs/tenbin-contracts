...
contract ControllerTest is BaseTest {
    ...
    function test_Version() public view {
        assertEq("1.0.5", controller.version());
    }
    ...
    function test_Revert_OracleAdapter_Mint() public {
        ...
        // set answer 1 wei below tolerance and perform mint
    ...
    function test_fuzz_Revert_OracleAdapter(uint96 tolerance, uint256 collateralAmount) public {
        ...
        collateralAmount = bound(collateralAmount, 1e6, 1e40);
        ...
        uint256 newOraclePrice = oraclePrice + Math.mulDiv(oraclePrice, tolerance + ADAPTER_PRECISION, 1e18);
        ...
        // set new oracle price slightly below tolerance
        newOraclePrice = oraclePrice - Math.mulDiv(oraclePrice, tolerance + ADAPTER_PRECISION, 1e18);
        aggregator.setAnswer(newOraclePrice);
