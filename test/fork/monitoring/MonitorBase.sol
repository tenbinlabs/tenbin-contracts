...
contract MonitorBase is ForkBaseTest {
    ...
    function setUp() public override {
        ...
        contracts = abi.decode(vm.parseJson(json, ".mainnet.tGLD.contracts"), (DeployedContracts));

        // get vault contracts
        vaultContracts = abi.decode(vm.parseJson(json, ".mainnet.tGLD.vault.contracts"), (VaultContracts));

        // get roles
        roles.admin_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.admin_role"), (address[]));
        roles.cap_adjuster_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.cap_adjuster_role"), (address[]));
        roles.curator_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.curator_role"), (address[]));
        roles.custodian_keeper_role =
            abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.custodian_keeper_role"), (address[]));
        roles.default_admin_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.default_admin_role"), (address[]));
        roles.gatekeeper_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.gatekeeper_role"), (address[]));
        roles.minter_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.minter_role"), (address[]));
        roles.multicaller_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.multicaller_role"), (address[]));
        roles.rebalancer_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.rebalancer_role"), (address[]));
        roles.restricter_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.restricter_role"), (address[]));
        roles.revenue_keeper_role =
            abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.revenue_keeper_role"), (address[]));
        roles.rewarder_role = abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.rewarder_role"), (address[]));
        roles.signer_manager_role =
            abi.decode(vm.parseJson(json, ".mainnet.tGLD.roles.signer_manager_role"), (address[]));
